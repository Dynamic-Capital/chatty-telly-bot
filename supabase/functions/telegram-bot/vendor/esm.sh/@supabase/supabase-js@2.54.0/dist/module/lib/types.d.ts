import { AuthClient } from 'https://esm.sh/@supabase/auth-js@2.71.1/dist/module/index.d.ts';
import { RealtimeClientOptions } from 'https://esm.sh/@supabase/realtime-js@2.15.0/dist/module/index.d.ts';
import { PostgrestError } from 'https://esm.sh/@supabase/postgrest-js@1.19.4/dist/cjs/index.d.ts';
import { StorageClientOptions } from 'https://esm.sh/@supabase/storage-js@2.10.4/dist/module/StorageClient.d.ts';
