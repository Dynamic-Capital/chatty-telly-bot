...
export function async<T = undefined, TYield = unknown, TReturn = unknown>(
  ...
  TYield extends PromiseLike<infer Await> ? Await
    : Exclude<TYield, awrap<unknown>>,
  TReturn extends PromiseLike<infer Await> ? Await
...
export function values<I extends Iterator<unknown, unknown, unknown>>(
  iterable: { [Symbol.iterator](): I },
): I;
