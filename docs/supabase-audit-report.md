...
- Added foreign key constraints linking analytics tables (`conversion_tracking`, `promo_analytics`,
  `user_surveys`) to `subscription_plans` for improved data integrity.
