                  ...
                  <div className='space-y-3'>
                    ...
                    {botStatus.bot_info && (
                      <div className='text-sm space-y-1'>
                        <p>
                          <strong>Bot:</strong> @{botStatus.bot_info.username}
                        </p>
                        <p>
                          <strong>Name:</strong> {botStatus.bot_info.first_name}
                        </p>
                        <p>
                          <strong>ID:</strong> {botStatus.bot_info.id}
                        </p>
                      </div>
                    )}
                  </div>
                  ...
                  <div className='space-y-3'>
                    ...
                    {botStatus.webhook_info && (
                      <div className='text-sm space-y-1'>
                        ...
                        <p>
                          <strong>Pending Updates:</strong> {botStatus.pending_updates || 0}
                        </p>
                  ...
                  {botStatus.bot_status?.includes('✅') && botStatus.webhook_status?.includes('✅')
                    ? (
                      <p className='text-green-600'>
                        ✅ Bot is properly configured and should respond to commands
                      </p>
                    )
                    : (
                      <div className='text-red-600 space-y-1'>
                        ...
                        {!botStatus.webhook_status?.includes('✅') && (
                          <p>• Webhook not properly configured</p>
                        )}
                      </div>
                    )}
