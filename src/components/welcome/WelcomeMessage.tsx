      ...
      <div className='container mx-auto px-4 py-12'>
        ...
        <div className='text-center mb-16'>
          ...
          <p className='text-xl text-muted-foreground max-w-2xl mx-auto mb-8'>
            Your intelligent trading companion powered by cutting-edge AI technology. Get real-time
            market analysis, trading signals, and education all in one place.
          </p>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16'>
          <Card className='border-2 hover:border-primary/50 transition-colors'>
            <CardHeader>
              ...
              <CardDescription>
                Get instant answers to your trading questions from our advanced AI trained on market
                data
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <div className='text-center bg-gradient-to-r from-primary/10 to-primary/5 rounded-2xl p-12'>
          ...
          <p className='text-muted-foreground mb-8 max-w-2xl mx-auto'>
            Join thousands of traders who are already using our AI assistant to make better trading
