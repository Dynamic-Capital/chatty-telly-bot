                    ...
                    >
                      <div className='flex items-center gap-3'>
                        ...
                        <div>
                          ...
                          {func.error && <p className='text-xs text-red-500'>{func.error}</p>}
                        </div>
                      </div>
                      ...
                      <div className='flex items-center gap-3'>
                        ...
                        <div>
                          ...
                          <p className='text-sm text-muted-foreground'>
                            ...
                            {table.hasRLS && (
                              <span className='ml-2 text-green-600'>• RLS Enabled</span>
                            )}
                          </p>
                          {table.lastUpdated && (
                            <p className='text-xs text-muted-foreground'>
                ...
                <div className='flex justify-between items-center'>
                  ...
                  <Badge variant='outline'>
                    {functions.length > 0
                      ? `${
                        Math.round(
                          functions.reduce((sum, f) => sum + (f.responseTime || 0), 0) /
                            functions.length,
                        )
                      }ms`
                      : 'N/A'}
          ...
          {errorFunctions > 0 && (
            <Alert variant='destructive'>
              ...
              <AlertDescription>
                ...
                edge function(s) are not responding properly. This may affect bot functionality.
                Check the Functions tab for details.
              </AlertDescription>
            </Alert>
          )}
