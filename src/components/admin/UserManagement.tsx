              ...
              <div className='space-y-4'>
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setNewUser((prev) => ({ ...prev, telegram_id: e.target.value }))}
              ...
              <div className='space-y-4'>
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setPackageAssignment((prev) => ({ ...prev, user_id: value }))}
                  >
                    <SelectTrigger>
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setPackageAssignment((prev) => ({ ...prev, package_id: value }))}
                  >
                    <SelectTrigger>
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setPackageAssignment((prev) => ({ ...prev, expires_at: e.target.value }))}
                  />
                </div>
                <div>
                  ...
                  <Textarea
                    ...
                    onChange={(e) =>
                      setPackageAssignment((prev) => ({ ...prev, notes: e.target.value }))}
                    ...
                    <TableBody>
                      {filteredUsers.map((user) => (
                        <TableRow key={user.id}>
                          ...
                          <TableCell>
                            <div>
                              {user.telegram_id && <div className='text-sm'>{user.telegram_id}
                              </div>}
                              {user.username && (
                                <div className='text-sm text-muted-foreground'>
                                  @{user.username}
